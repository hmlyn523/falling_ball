...
class Connect extends SpriteAnimationComponent {
  ...
  Future<void> onLoad() async {
    ...
    this.animation = SpriteAnimation.spriteList(await Future.wait(sprites),stepTime: .5,);
...
class CancelButton extends SpriteComponent with TapCallbacks,
  ...
  Future<void> onLoad() async {
    ...
    size = Vector2(Config.WORLD_WIDTH * .41, Config.WORLD_HEIGHT * .08);
